...
public class EdgeConvertGUI {
   ...
   public void createDTScreen() {//create Define Tables screen
      ...
      jmiDTHelpDocumentation = new JMenuItem("Documentation");
   ...
   public void createDRScreen() {
      ...
      jmiDRHelpDocumentation = new JMenuItem("Documentation");
   ...
   private void getOutputClasses() {
      ...
      try {
         ...
         for (int i = 0; i < resultFiles.length; i++) {
            //System.out.println(resultFiles[i].get   Name());
            ...
            if (resultClass.getSuperclass().getName().equals("com.bobbytables.app.EdgeConvertCreateDDL")) { //only interested in classes that extend EdgeConvertCreateDDL
